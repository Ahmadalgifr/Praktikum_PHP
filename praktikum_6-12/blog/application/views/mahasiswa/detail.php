        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                    <img src="<?= base_url() ?>uploads/photos/<?=$siswa->id?>.png" width="300" alt="">
                    <div class="mt-5">
                        <h4><?=$siswa->nama?></h4>
                        <p>Foto Mahasiswa</p>
                        <!-- <?php echo $error;?> -->
                        <br>
                        <a href="https://www.instagram.com/AhmadAlgifr/"><button class="btn btn-outline-primary">Instagram</button></a> 
